...
const pages = [
  ...
  {
    title: "Get Started",
    subtitle: "Join millions of movie lovers and start your cinematic journey today.",
    imageUrl:
  ...
  return (
    <View style={styles.container}>
      ...
      <Onboarding
        ...
        DoneButtonComponent={(props) => <DoneButton {...props} onPress={handleOnboardingComplete} />}
